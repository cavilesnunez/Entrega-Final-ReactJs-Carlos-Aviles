    ...
    <div>
            ...
            <div className="flex  items-center justify-start bg-white">
              <div className="mx-auto w-full max-w-lg">
                ...
                <p className="mt-4 mb-4">Envíenos un correo electrónico a <span className="text-blue-900 hover:text-blue-700 font-bold">contacto@keebmx.com</span> o envíenos un mensaje aquí:</p>
                ...
                <form action="" className="">
                  ...
                  <div className="grid gap-6 sm:grid-cols-2">
                    ...
                    <div className="relative z-0">
                      ...
                      <label className="absolute top-3 -z-10 origin-[0] -translate-y-6 scale-75 transform text-sm text-gray-500 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:left-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-blue-600 peer-focus:dark:text-blue-500">Tu correo</label>
                    </div>
                  ...
                  <button type="submit" className="text-center mt-5 rounded-md bg-blue-900 hover:bg-blue-700 text-white px-10 py-2">Enviar</button>
                </form>
              </div>
            </div>
